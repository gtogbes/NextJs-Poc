      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h2 className="h2 font-cabinet-grotesk">We support Trainees, Doctors and Other NHS trusts.</h2>
          </div>
          ...
          <div className="relative pb-12">
            ...
            <div className="max-w-sm mx-auto grid gap-12 sm:grid-cols-2 sm:max-w-3xl lg:grid-cols-4 lg:max-w-none items-start">
              ...
              <div className="text-center">
                ...
                <h3 className="font-cabinet-grotesk font-bold text-lg">NHS Core value</h3>
                <div className="text-gray-500">working together for patients.</div>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-cabinet-grotesk font-bold text-lg">NHS Core value</h3>
                <div className="text-gray-500">respect and dignity.</div>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-cabinet-grotesk font-bold text-lg">NHS Core value</h3>
                <div className="text-gray-500">commitment to quality of care.</div>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-cabinet-grotesk font-bold text-lg">NHS Core values</h3>
                <div className="text-gray-500">compassion, improving lives, everyone counts.</div>
              </div>
            </div>
          </div>
