        ...
        <div className="pt-28 pb-16 md:pt-40 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="h1 font-cabinet-grotesk text-white mb-2" data-aos="fade-up">
              NHSE Trainee Nextjs-Hosting investigation.
            </h1>
            <p className="text-lg md:text-xl text-white text-opacity-80 mb-8" data-aos="fade-up" data-aos-delay="100">
              To help in understanding how to move towards fully supporting the latest React and Next.js features we need to investigate the best way to deploy and host a proper Next.js application.
            </p>
