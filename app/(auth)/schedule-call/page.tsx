...
export default function ScheduleCall() {
  return (
    <>
      <div className="mb-10">
        <h1 className="h2 font-cabinet-grotesk">Get matched to qualified Healthcare Practitioners</h1>
      </div>
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-sm font-medium mb-1" htmlFor="company">
              Individual/Company Name <span className="text-pink-500">*</span>
            </label>
          ...
          <div>
            <label className="block text-sm font-medium mb-1" htmlFor="role">
              What is your occupation? <span className="text-pink-500">*</span>
            </label>
